...
def add_char_image():
        ...
        handWrittenCharFileName = utils.HAND_WRITTEN_CHAR_FILE_NAME
        image.save(handWrittenCharFileName, 'PNG')
        #handWrittenCharFileName = 'onlineCharacter2.png'
        predicted_chars, predicted_indexes, predicted_probabilities = recognizer(handWrittenCharFileName)

        #predicted_chars, predicted_indexes, predicted_probabilities = recognizer(handWrittenCharFileName, sess, graph, training_init_op, saver)
